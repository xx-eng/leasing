...
import cn.edu.zuel.common.module.Firm;
...
public class FirmService extends BaseService<Firm> {
    ...
    public BaseResult login(boolean keepLogin, String account, String password) {
        ...
        Firm user = get(cond, "getByFirmLogin");
        ...
        userSession = sessionService.add(user.getId().longValue(), liveSeconds, 2);
        if (userSession == null) {
